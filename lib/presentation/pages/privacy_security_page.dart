  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return userDataAsync.when(
      ...
      data: (userData) {
        ...
        final devices = List<String>.from(userData['devices'] ?? []);
        final lastLogin = userData['lastLogin'];
        final screenshotAttempts = userData['screenshotAttempts'] ?? 0;
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 4),
                              Text(
                                '$screenshotAttempts screenshot ${screenshotAttempts == 1 ? "attempt" : "attempts"} detected',
                                style: Theme.of(context).textTheme.bodySmall
